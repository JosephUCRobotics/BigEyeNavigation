...
public class BlobProcessor {
    ...
    void updateBlobPos(){
        ...
        if (maxContour != null) {
            ...
            // the red dot
            int screenCenterX = CameraVariables.cameraHeight*2 / 2;
            int screenCenterY = CameraVariables.cameraWidth / 2;
            CameraVariables.distanceX = centerX - screenCenterX;
            int distanceY = centerY - screenCenterY;
            String distanceInfo = "Distance: X=" + CameraVariables.distanceX + ", Y=" + distanceY;
